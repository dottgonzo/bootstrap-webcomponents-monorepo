...
export function printInvoice(opts: { headers: IHeaders; items: IItem[]; version: string }) {
...
export function OpenInvoiceWindow(opts: { headers: IHeaders; items: IItem[]; version: string }) {
	const w = window.open("", "PRINT", "height=400,width=600");
