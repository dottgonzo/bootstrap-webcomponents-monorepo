...
const examples: { name: string; description?: string; data: Component }[] = [
	{
		...
		data: {
			data: [
				...
				{ href: "https://via.placeholder.com/300x200/0000FF", caption: "HTMLbricks2", externalLink: "https://docs.htmlbricks.kernel.online" },
				{ href: "https://via.placeholder.com/300x200/00FFFF", caption: "HTMLbricks3", link: "https://docs.htmlbricks.kernel.online" },
		...
		data: {
			data: [
				{ href: "https://via.placeholder.com/300x200/FFFFFF", caption: "HTMLbricks", duration: "33 seconds" },
				{
					...
					caption: "HTMLbricks2",
					duration: "00:33",
					externalLink: "https://docs.htmlbricks.kernel.online",
				},
				{ href: "https://via.placeholder.com/300x200/00FFFF", caption: "HTMLbricks3", link: "https://docs.htmlbricks.kernel.online" },
				{ href: "https://via.placeholder.com/300x200/a94949", caption: "HTMLbricks4", key: "htmlbricks" },
				{ href: "https://via.placeholder.com/300x200/49a962", caption: "HTMLbricks5" },
