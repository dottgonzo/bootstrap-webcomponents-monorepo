...
> = readable([
	...
	{ name: '--bs-primary-rgb', value: '7, 104, 159', type: 'string' },
	{ name: '--bs-secondary-rgb', value: '201, 214, 223', type: 'string' },
	{ name: '--bs-success-rgb', value: '17, 211, 188', type: 'string' },
	{ name: '--bs-info-rgb', value: '162, 213, 242', type: 'string' },
	{ name: '--bs-warning-rgb', value: '255, 126, 103', type: 'string' },
	{ name: '--bs-danger-rgb', value: '246, 114, 128', type: 'string' },
	{ name: '--bs-light-rgb', value: '250, 250, 250', type: 'string' },
	{ name: '--bs-dark-rgb', value: '78, 78, 78', type: 'string' },
	{ name: '--bs-white-rgb', value: '255, 255, 255', type: 'string' },
	{ name: '--bs-black-rgb', value: '0, 0, 0', type: 'string' },
	{ name: '--bs-body-color-rgb', value: '33, 37, 41', type: 'string' },
	{ name: '--bs-body-bg-rgb', value: '255, 255, 255', type: 'string' },
	{
